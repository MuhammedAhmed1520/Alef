        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form class="form-horizontal" method="post" action="{{url('/admin/book')}}" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5 {{ $errors->has('fname') ? ' has-error' : '' }}">
                                    <input type="text" name="fname" class="form-control" id="fname" placeholder="First Name" value="{{ old('fname') }}" required autofocus>
                                    @if ($errors->has('fname'))
                                ...
                                <div class="col-sm-5 {{ $errors->has('lname') ? ' has-error' : '' }}">
                                    <input type="text" name="lname" class="form-control" id="lname" placeholder="Last Name" value="{{ old('lname') }}" required autofocus>
                                    @if ($errors->has('lname'))
                                        <span class="help-block">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5 {{ $errors->has('phone') ? ' has-error' : '' }}">
                                    <input type="text" name="phone" class="form-control" id="phone" placeholder="Phone Number" value="{{ old('phone') }}" required autofocus>
                                    @if ($errors->has('phone'))
                                        <span class="help-block">
                                ...
                                <div class="col-sm-5 {{ $errors->has('email') ? ' has-error' : '' }}">
                                    <input type="text" name="email" class="form-control" id="email" placeholder="Email Address" value="{{ old('email') }}" required autofocus>
                                    @if ($errors->has('email'))
                                        <span class="help-block">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5 {{ $errors->has('address1') ? ' has-error' : '' }}">
                                    <input type="text" name="address1" class="form-control" id="address1" placeholder="Address 1" value="{{ old('address1') }}" required autofocus>
                                ...
                                <div class="col-sm-5 {{ $errors->has('address2') ? ' has-error' : '' }}">
                                    <input type="text" name="address2" class="form-control" id="address2" placeholder="Address 2" value="{{ old('address2') }}" required autofocus>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5 {{ $errors->has('city') ? ' has-error' : '' }}">
                                    <input type="text" name="city" class="form-control" id="city" placeholder="City" value="{{ old('city') }}" required autofocus>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5 {{ $errors->has('postcode') ? ' has-postcode' : '' }}">
                                    <input type="text" name="postcode" class="form-control" id="postcode" placeholder="postcode" value="{{ old('postcode') }}" required autofocus>
