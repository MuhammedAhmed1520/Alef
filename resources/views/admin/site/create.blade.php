        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form class="form-horizontal" method="post" action="{{url('/admin/site')}}" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5 {{ $errors->has('name') ? ' has-error' : '' }}">
                                    <input type="text" name="title" class="form-control" id="name" placeholder="name" value="{{ old('name') }}" required autofocus>
                                    @if ($errors->has('name'))
